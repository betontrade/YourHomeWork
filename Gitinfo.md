...
## Список команд для работы с git hub:

1.  _git clone https...._ клонирует репозиторий на локальный компьютер

2. _git push_  загружает на гитхаб изменения в файлах

3. _git pull_ скачивает с гитхаба изменения

_Что бы проще было запомнить push - толкать от себя, pull - тянуть на себя_



   __конец домашнего задания к лекции 3__